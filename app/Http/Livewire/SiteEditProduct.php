...
class SiteEditProduct extends Component
{     use WithFileUploads;
      public $name;
      public $slug;
...
public function generateSlug()
{
  ...
  public function update(){
    ...
    {    $this->stockcategory = StockCategory::all();
        return view('livewire.site-edit-product',['stockcategory'=>$this->stockcategory])->extends('layouts.sitestockapp')->section('content');
    }
}
