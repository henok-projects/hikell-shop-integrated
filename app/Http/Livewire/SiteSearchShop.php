...
class SiteSearchShop extends Component
{
    use WithPagination;
...

    {
       ...
       return view('livewire.site-search-shop', ['products' => $products,'categories'=>$categories])->extends('layouts.sitestockapp')->section('content');
