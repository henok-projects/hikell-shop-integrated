...
class ShopStatus extends Component
{
    public function render()
    {
        ...
        return view('livewire.shop-status',['orders'=>$orders,'totalcost'=>$totalcost,'totalPurchase'=>$totalPurchase,'totalDelivered'=>$totalDelivered,'totalCanceled'=>$totalCanceled])->layout('layouts.sitebase');
    }
}
