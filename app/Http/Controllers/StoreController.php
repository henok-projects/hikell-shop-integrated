...
class StoreController extends Controller
{
    ...
    {   $asUser=false;
        ...
        if ($site) {
            $stocks = Stock::where('user_id', $curUser->user_id);
            return view('stores.preview', compact('site', 'stocks','asUser','freeTrial'));
    ...
    public function all($site_name)
    {
        ...
        if ($site) {
            $videos = Stock::where('site_id', $site->site_id)->get();
            $pageTitle = 'Stocks';
            return view('stores.stocks', compact('site', 'stocks', 'pageTitle'));
        }

        return view('stores.index', compact('site'));
    }
    ...
    {   
        ...
        if ($site) {
            ...
            return view('stores.preview', compact(['site','asUser','freeTrial']));
        } else {
            return redirect()->back();
        }
    }
