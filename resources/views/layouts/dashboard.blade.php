        ...
        <nav id="header" class="fixed top-0 z-30 w-full bg-gray-100">
            <div class="container flex flex-wrap items-center justify-between w-full py-4 mx-auto mt-0">
                <div class="flex flex-wrap items-center pl-4 md:flex-row">
                    ...
                    <a href="{{url('user',['main'=>'dashboard'])}}"
                        class="ml-1 text-base font-bold no-underline hover:text-gray-300 hover:no-underline md:ml-4 md:text-xl sm:ml-2">
                        Dashboard
                    </a>
                    <a href="{{url('user',['main'=>'ebook'])}}"
                        class="ml-1 text-base no-underline hover:text-gray-300 hover:no-underline semi-bold md:ml-4 sm:ml-2">
                        Ebook & PodCast
                    </a>
                    <a href="{{url('user',['main'=>'payment'])}}"
                        class="ml-1 text-base no-underline hover:text-gray-300 hover:no-underline semi-bold md:ml-4 sm:ml-2">
                        Balance & Payments
                    </a>
                    <a href="{{url('user',['main'=>'setting'])}}"
                        class="ml-1 text-base no-underline hover:text-gray-300 hover:no-underline semi-bold md:ml-4 sm:ml-2">
                        Setting
                    </a>
                  <a href="{{url('user',['main'=>'store','content'=>'products'])}}"
                        class="ml-1 text-base no-underline hover:text-gray-300 hover:no-underline semi-bold md:ml-4 sm:ml-2">
                        Store
                    </a>
                </div>
                <div class="flex flex-wrap pr-4 lg:hidden">
                    <button id="nav-toggle"
                        class="flex items-center px-3 py-2 border border-gray-600 rounded appearance-none hover:text-gray-300 focus:outline-none">
                ...
                <div class="z-40 justify-between hidden w-full mt-3 lg:flex lg:content-center lg:items-center lg:w-auto lg:mt-0"
                    id="nav-content">
                    <div class="w-full py-4 mx-auto lg:max-w-sm lg:flex-1 lg:py-0 lg:float-none">
                        <div class="relative pl-4 pr-4 pull-right md:pr-0">
                            <input type="text" placeholder="Search" x-bind:class="{ 'bg-gray-800': dark }"
                            ...
                            <div class="absolute search-icon" style="top: 0.375rem;left: 1.75rem;">
                                <svg class="w-4 h-4 pointer-events-none fill-current" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
                                    <path
                    ...
                    <ul class="inline-flex items-center float-right p-0 list-none">
                        <li class="py-2 mr-3 lg:py-0">
                            <a class="inline-block px-4 py-2 font-bold no-underline hover:text-gray-300"
                                href="{{ route('support') }}">Help?</a>
                        </li>
                        <li class="py-2 mr-3">
                            <div class="flex items-center mt-3 md:ml-4 md:mt-0" x-data="{ isOpen:false}">
                                <a class="flex items-center" @click="isOpen = !isOpen" @click.away="isOpen=false">
                                    ...
                                    <div x-show.transition.opacity="isOpen" @keydown.escape.window="isOpen = false"
                                        ...
                                        <ul class="p-0 list-none ">
                                            <li><a href="{{ route('home') }}"
                                                    class="block px-3 py-3 transition duration-150 ease-in-out hover:bg-gray-200">Hikell
                                                    Home</a></li>
                                            <li>
