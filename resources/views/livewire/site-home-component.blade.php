		...
		<div class="wrap-main-slide">
			<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
				...
				<div class="item-slide">
					<img  src="{{asset('assets/images/products')}}/{{$p_products->image}}" alt="" class="img-slide">
					<div class="slide-info slide-1">
						<h2 class="f-title">{{$p_products->name}}<b></b></h2>
						<span class="subtitle">{{$p_products->short_description}}</span>
						<p class="sale-info">Only price: <span class="price">{{$p_products->regular_price}}</span></p>
						<a href="{{route('product.details',['slug' =>$p_products->slug])}}" class="btn-link">Shop Now</a>
					</div>
				</div>
                @endforeach
			</div>
