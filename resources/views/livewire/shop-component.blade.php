	...
	<div class="container">
		<div class="wrap-breadcrumb">
			<ul>
				...
				<li class="item-link"><span>Store</span></li>
			</ul>
		</div>
						...
						<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
							<div class="product product-style-3 equal-elem ">
								...
								<div class="product-info">
									...
									{{-- <a href="{{route('product.edit',['slug' => $product->slug])}}" class="btn add-to-cart"
										>Editt</a> --}}
				...
				<div class="widget mercado-widget filter-widget">
					...
					<div class="widget-content">
						...
						<div class="widget-banner">
							...
							<a href="{{route('product.details',['slug' =>$banner->slug])}}">
								<figure><img src="{{asset('assets/images/products')}}/{{$banner->image}}" width="270"
