            ...
            <div class="product-item bg-light mb-4">
                <div class="product-img position-relative overflow-hidden">
                    ...
                    <div class="product-action">
                        ...
                        <a class="btn btn-outline-dark btn-square" href="{{route('product.sitedetails',['slug' =>$product->slug,'site_id'=>$product->site_id])}}"><i class="fa fa-eye" title="View details"></i></a>

                    </div>
                </div>
                <div class="text-center py-4">
                    <a class="h6 text-decoration-none text-truncate" href="{{route('product.sitedetails',['slug' =>$product->slug,'site_id'=>$product->site_id])}}">{{$product->name}}</a>
