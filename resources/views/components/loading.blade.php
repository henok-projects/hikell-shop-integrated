@props(['msg'])
<button type="button" id="loadingComp" class="hidden inline-flex my-2" disabled>
    <svg class="animate-spin fill-current text-gray-200 h-5 w-5 mr-2" viewBox="0 0 24 24" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
