@props(['price', 'title', 'descr'])

<div class="flex h-screen w-full justify-between items-center">
    <div class="bg-indigo-900 text-lg w-full h-full">
        {{-- Payment Info and Hikell service info --}}

        <div class="flex items-start h-full flex-col justify-between lg:pl-44 lg:pt-28 pl-12 pr-4 text-white">
    ...
    <div class="bg-gray-900 w-full h-full">
        ...
        <div class="flex justify-between space-y-8 flex-col lg:pr-36 lg:pt-28 pr-12 lg:pl-24 text-white">
            ...
            <div>
                ...
                <form method="post" id="payment-form">
                    <div class="flex flex-col space-y-2">
                        ...
                        <x-input placeholder="Email..." id="email" class="block bg-transparent border rounded-lg focus:placeholder-gray-200 border-gray-700 focus:outline-none mt-1 w-full" type="email" name="email"  required autofocus />
                    </div>
                    ...
                    <input type="hidden" name="priceId" id="priceId" value="price_1K1QlOLgKecwwaMemzWKSAJ8">
