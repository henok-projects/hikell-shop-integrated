<div class="w-full text-xl leading-normal lg:w-1/5 lg:px-6">
    <p class="hidden w-full h-64 py-2 pt-2 mt-0 lg:pb-6 lg:h-auto lg:overflow-y-hidden lg:block ">Stocks</p>
    ...
    <div class="sticky inset-0 z-20 hidden w-full h-auto mt-0 overflow-x-hidden overflow-y-auto  border border-gray-700 shadow lg:h-auto lg:overflow-y-hidden lg:block lg:border-transparent lg:shadow-none lg:bg-transparent" style="top:5em;" id="menu-content">
       <ul class="flex flex-col p-0 list-none">
          <li class="py-2 md:my-0 hover:bg-gray-300 lg:hover:bg-transparent">
             <a href="{{ url('user',['menu'=>'store','content'=>'products']) }}" class="block pl-4 no-underline align-middle border-l-4 border-transparent hover:text-black lg:hover:border-gray-600">
             <span class="pb-1 text-sm md:pb-0">Stocks</span>
             </a>
          </li>
          <li class="py-2 md:my-0 hover:bg-gray-300 lg:hover:bg-transparent">
            <a href="{{ url('user',['menu'=>'store','content'=>'store']) }}" class="block pl-4 no-underline align-middle border-l-4 border-transparent hover:text-black lg:hover:border-gray-600">
            <span class="pb-1 text-sm md:pb-0">Settings</span>
            </a>
         </li>
         <li class="py-2 md:my-0 hover:bg-gray-300 lg:hover:bg-transparent">
            <a href="{{ url('user',['menu'=>'store','content'=>'deliverd']) }}" class="block pl-4 no-underline align-middle border-l-4 border-transparent hover:text-black lg:hover:border-gray-600">
            <span class="pb-1 text-sm md:pb-0">Shipping Progress</span>
            </a>
         </li>
       </ul>
    </div>
