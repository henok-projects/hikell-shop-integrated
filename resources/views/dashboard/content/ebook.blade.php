<div class="w-full px-8 leading-normal lg:w-4/5">
    <div class="flex items-center justify-between font-sans">
        ...
        {{-- @if(isset($site) && $site->count()>0)
        <a href="{{ route('book.upload') }}" class="flex items-center justify-between px-3 py-1 text-lg font-semibold text-white bg-green-800 rounded hover:bg-green-900">
