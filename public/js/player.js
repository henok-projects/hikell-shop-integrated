...
function togglePlay() {
  if (video.paused || video.ended) {
    ...
    video.pause();
    playbackAnimation.style.opacity=10
  }
}
...
function formatTime(timeInSeconds) {
  ...
  const seconds = (result.getSeconds()<10?'0':'')+result.getSeconds();
  return {
    minutes: minutes,
    seconds: seconds,
  };
...
video_container.addEventListener('mouseenter', showControls);
...
document.addEventListener('loadvideo', event=>{
